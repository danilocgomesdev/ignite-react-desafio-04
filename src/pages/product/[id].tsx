...
export default function Product({ product }: IProduct) {
  ...
  const buttonText = itemAlreadyInCart ? "Produto já está no carrinho" : "Colocar na sacola";
    ...
    <>
      ...
      <ProductContainer>
        ...
        <ProductDetails>
          ...
          <button type="button" onClick={() => addToCart(product)} disabled={itemAlreadyInCart}>
            {buttonText}
          </button>
        </ProductDetails>
      </ProductContainer>
